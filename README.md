To use go to our [site (veerhan-glitch.github.io)](https://veerhan-glitch.github.io/) or to run localy run [app.py](app.py) file then go to the local host link provided in the terminal
